...
export default class LeMiePrenotazioni extends Component{
            ...
            buttons: [
                {
                    ...
                    onClick: () => {
                        ...
                        axios.post("https://stardust-deploy-test.herokuapp.com/Client/EliminaPrenotazione_del", this.state)
    ...
    componentWillMount(){
        ...
        axios.post("https://stardust-deploy-test.herokuapp.com/Client/RitiroMezzo_get", this.state).
            then(result => {
