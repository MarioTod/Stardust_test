...
export default class LeMieCorse extends Component{
    ...
    componentWillMount(){
        ...
        axios.post("https://stardust-deploy-test.herokuapp.com/Client/TerminaCorsa_get", this.state).
            then(result => {
                            ...
                            <Button variant="dark" style={{margin:"10px"}}
                                onClick={
                                    clickEvent =>{              
                                        ...
                                        axios.post("https://stardust-deploy-test.herokuapp.com/Client/TerminaCorsa_del", oggetto).
                                        then(result => {
