                        ...
                        <Button variant="primary" style={{margin:"10px"}}
                            onClick={
                                clickEvent =>{
                                    ...
                                    const oggettoBloccoVeicolo={
                                        code_prenotation: corsa.ref_pren
                                    }

                                    axios.post("http://localhost:3000/Client//RitiroMezzo_close", oggettoBloccoVeicolo).
                                    then(result => {
                                        alert("Mezzo chiuso con successo!")
