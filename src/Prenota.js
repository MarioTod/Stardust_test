                ...
                <div>
                    ...
                    <Form.Control as="select" defaultValue="Choose..." 
                                    ...
                                    required>
                                        ...
                                        <option value="" selected> Scegli</option>
                                        <option value="stallo 1" >Stallo 1</option>
                                        <option value="stallo 2" >Stallo 2</option>
                                        <option value="stallo 3" >Stallo 3</option>       
            ...
            <div >
                ...
                <h4 align="center"> Seleziona con quale opzione vuoi viaggiare.<br/>Hai bisogno di un mezzo o di un autista? </h4> <br/><br/>
                        ...
                        <br/><br/><br/>
                            ...
                            {/* <p>{this.state.oraInizio}</p> */}
                            <br/><br/>


                            <div>
                                {inputIndirizzoPartenza}
                                {/* <p>{this.state.indirizzoPartenza}</p> */}
                            </div>
                            ...
                            <div>
                                {inputIndirizzoArrivo}
                                {/* <p>{this.state.indirizzoArrivo}</p> */}
                            </div>
